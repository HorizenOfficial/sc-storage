...
public class Library {
    ...
    private final static String commonLibName = "sc_storage";

    private final static String windowsOsName = "windows";
    private final static String linuxOsName = "linux";
    private final static String osxOsName = "osx";

    private final static String windowsLibName = commonLibName + ".dll";
    private final static String linuxLibName = "lib" + commonLibName + ".so";
    private final static String osxLibName = commonLibName + ".jnilib";
